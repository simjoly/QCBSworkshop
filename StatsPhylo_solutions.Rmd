...
Once you have cloned the repository, you need to open R (R studio) and set the working directory to the repository folder ("/QCBSworkshop2017"). In RStudio, to change the working directory, you choose `>Session>Set Working directory>Choose Directory`.You are now ready to do the exercises.
